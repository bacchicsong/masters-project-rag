...
**R@K (Recall@K)** - доля вопросов, для которых нужная статья есть где-то в top-K. Это hit rate: «нашли ли мы правильный документ, если смотреть на K первых результатов». R@5 = 0.6 значит, что в 12 из 20 запросов статья попала в пятёрку.
...
|-----------|-----|-----|-----|-----|
| full | 0.4 | 0.18 | 0.12 | 0.6 |
| title_only | 0.2 | 0.07 | 0.05 | 0.25 |
| title_headings | 0.1 | 0.05 | 0.03 | 0.15 |

chunk size (full text, поиск по чанкам, overlap=50):

| size | P@1 | P@3 | P@5 | R@5 |
|------|-----|-----|-----|-----|
| 1024 | 0.4 | 0.17 | 0.11 | 0.55 |
| 512 | 0.2 | 0.13 | 0.09 | 0.45 |
| 256 | 0.15 | 0.12 | 0.08 | 0.4 |
...
| 50 | 0.2 | 0.13 | 0.09 | 0.45 |
| 100 | 0.25 | 0.17 | 0.12 | 0.6 |
| 200 | 0.25 | 0.13 | 0.08 | 0.4 |
